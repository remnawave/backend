...
export const REST_API = {
    ...
    BANDWIDTH_STATS: {
        ...
        USER_IPS: {
            CREATE: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_USER_IPS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.USER_IPS.CREATE(uuid)}`,
            GET_RESULT: (jobId: string) =>
                `${ROOT}/${CONTROLLERS.BANDWIDTH_STATS_CONTROLLER}/${CONTROLLERS.BANDWIDTH_STATS_USER_IPS_ROUTE}/${CONTROLLERS.BANDWIDTH_STATS_ROUTES.USER_IPS.GET_RESULT(jobId)}`,
        },
        LEGACY: {
            NODES: {
                GET_USERS: (uuid: string) =>
