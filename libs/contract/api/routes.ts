...
export const REST_API = {
    ...
    NODES: {
        ...
        ACTUAL_USERS: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.NODES_CONTROLLER}/${CONTROLLERS.NODES_ROUTES.ACTUAL_USERS(uuid)}`,
        RECONCILE_USERS: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.NODES_CONTROLLER}/${CONTROLLERS.NODES_ROUTES.RECONCILE_USERS(uuid)}`,
    },
    USERS: {
